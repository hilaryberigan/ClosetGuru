...
namespace ClosetInventory.WorkerClasses
{
    ...
    public class OutfitGenerator
    {
        ...
        public Collections GetDressyClothes(Collections collections)
        {
            ...
            collections.Shoes = collections.Shoes.Where(m => m.DressinessRating > 6).ToList();
            collections.Dresses = collections.Dresses.Where(m => m.DressinessRating > 6).ToList();
            collections.PantsList = collections.PantsList.Where(m => m.DressinessRating > 5).ToList();
            collections.Covers = collections.Covers.Where(m => m.DressinessRating > 5).ToList();
        ...
        {
            collections.Shirts = collections.Shirts.Where(m => m.DressinessRating > 4).ToList();
            collections.Shoes = collections.Shoes.Where(m => m.DressinessRating > 5 && m.DressinessRating <7).ToList();
        ...
        {
            collections.Shirts = collections.Shirts.Where(m => m.WarmthRating <= 4).ToList();
            collections.Shoes = collections.Shoes.Where(m => m.WarmthRating <= 3).ToList();
            collections.Dresses = collections.Dresses.Where(m => m.WarmthRating <= 3).ToList();
            collections.PantsList = collections.PantsList.Where(m => m.WarmthRating <= 3 && m.isShorts != true).ToList();
            collections.Covers = collections.Covers.Where(m => m.WarmthRating <= 2).ToList();
            return collections;
        }
